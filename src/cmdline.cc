/*
  ...
  gengetopt --input=Iterative-HFold.ggo --c-extension=cc --header-extension=hh --arg-struct-name=args_info --unamed-opts=input
...
const char *args_info_help[] = {
  ...
  "  -v, --verbose                 Give a verbose output  (default=off)",
...
void init_args_info(struct args_info *args_info)
{
  ...
  args_info->shape_help = args_info_help[8] ;
  args_info->noConv_help = args_info_help[9] ;
  args_info->verbose_help = args_info_help[10] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVr:i:o:n:d:P:S:v", long_options, &option_index);
